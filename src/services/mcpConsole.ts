...
// 删除函数
export const deleteMcpFunctionApi = async (
  params: Record<string, any>
) => mcpCore.graphql({
  query: deleteMcpFunctionQl,
  variables: params
});

// 插入或更新函数
export const insertUpdateMcpFunctionApi = async (
  params: Record<string, any>
) => mcpCore.graphql({
  query: insertUpdateMcpFunctionQl,
  variables: params
});
...
// 删除函数调用
export const deleteMcpFunctionCallApi = async (
  params: Record<string, any>
) => mcpCore.graphql({
  query: deleteMcpFunctionCallQl,
  variables: params
});

// 插入或更新函数调用
export const insertUpdateMcpFunctionCallApi = async (
  params: Record<string, any>
) => mcpCore.graphql({
  query: insertUpdateMcpFunctionCallQl,
  variables: params
});


export const getListMcpSettingsApi = (
  params: SplitPageParams
) => mcpCore.graphql<McpSettingDataType[]>({
  query: listMcpSettingsQl,
  variables: getSplitPageParams(params)
});

export const insertUpdateMcpSettingApi = (
  params: Record<string, any>
) => mcpCore.graphql({
  query: insertUpdateMcpSettingQl,
  variables: params
});